 ...
 */
public abstract class PlayerCommand extends CheckedCommand {

    public PlayerCommand() {
        this(Range.all());
    }

    public PlayerCommand(final Range<Integer> range) {
        super(range);
    }

    @Override
    public final boolean onSafeCommand(CommandSender commandSender, Command command, String label, String[] args) {

...
public class Music implements CommandExecutor {
	...
	if (cmd.getName().equalsIgnoreCase("music")) {
		...
		if (args[0].equalsIgnoreCase("list")) {
		    ...
		    if (args[0].equalsIgnoreCase("13") || args[0].equalsIgnoreCase("cat")
			    || args[0].equalsIgnoreCase("blocks") || args[0].equalsIgnoreCase("chirp")
			    || args[0].equalsIgnoreCase("far") || args[0].equalsIgnoreCase("mall")
			    || args[0].equalsIgnoreCase("mellohi") || args[0].equalsIgnoreCase("stal")
			    || args[0].equalsIgnoreCase("strad") || args[0].equalsIgnoreCase("ward")
			    || args[0].equalsIgnoreCase("11") || args[0].equalsIgnoreCase("wait")) {
